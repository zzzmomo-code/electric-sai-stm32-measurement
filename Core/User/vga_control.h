...
/*
 * 下列六个值为 PA4/DAC1_OUT1 对地实测电压，仅供 VCA821 增益模型使用。
 * 重新标定时只修改对应宏，DAC 指令值保持不变。
 */
#define VGA_CONTROL_LEVEL_0_MEASURED_VOLTAGE_V 0.645f
#define VGA_CONTROL_LEVEL_1_MEASURED_VOLTAGE_V 0.746f
#define VGA_CONTROL_LEVEL_2_MEASURED_VOLTAGE_V 0.847f
#define VGA_CONTROL_LEVEL_3_MEASURED_VOLTAGE_V 0.948f
#define VGA_CONTROL_LEVEL_4_MEASURED_VOLTAGE_V 1.049f
#define VGA_CONTROL_LEVEL_5_MEASURED_VOLTAGE_V 1.150f
