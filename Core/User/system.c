 ...
 * PB14/AD9834_FSELECT、PD8/AD9834_PSELECT；AD9959使用PE2/SPI4_SCK、
 * PE5/SPI4_MISO、PE6/SPI4_MOSI、PD4/IO_UPDATE、PD5/CS和PB4/RESET。
 ...
 * @param 无。
 * @return 无。
 * @note 先初始化FFT的DWT诊断，再启动频率测量和AD9834本振；
 * AD9959初始化失败时由ad9959_diagnostics记录并保持硬件复位状态。
 */
