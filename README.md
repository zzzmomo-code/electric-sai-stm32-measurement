...
|---:|---:|---:|---:|---:|
| 0 | 0.617 | 0.617 | 0.664 | 1.079 |
| 1 | 0.717 | 0.717 | 6.919 | 2.218 |
| 2 | 0.817 | 0.817 | 13.173 | 4.557 |
| 3 | 0.917 | 0.917 | 16.409 | 6.613 |
| 4 | 1.017 | 1.017 | 18.660 | 8.570 |
| 5 | 1.117 | 1.117 | 19.525 | 9.468 |
...
`VGA_CONTROL_LEVEL_5_MEASURED_VOLTAGE_V` 当前先等于六档指令值。实板测量 PA4 后，
