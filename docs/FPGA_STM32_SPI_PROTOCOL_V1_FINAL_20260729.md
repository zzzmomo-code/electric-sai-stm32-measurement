...
> **已废止：不要再用于 FPGA 实现。** 本文的旧 128 字节帧头与 FPGA
> 2026-07-30 冻结版不一致。最新唯一依据为
> `FPGA_STM32_SPI_PROTOCOL_V1_0_FROZEN_20260730.md`。
...
| 34 | 2 | `time_uv_per_lsb` | 当前固定250，时域载荷为`int16_t`二补码 |
...
| 48 | 2 | `spectrum_uv_per_lsb` | 当前固定125，单位µV_peak/LSB |
